...
Last updated: 2024-11-17T00:27:46.142Z. Updates checked daily via [cron.yml](https://github.com/jasongitmail/shadcn-compare/actions/workflows/cron.yml).
...
| --- | --- | --- |
| Accordion | [🟢](https://ui.shadcn.com/docs/components/accordion) | [🟢](https://www.shadcn-svelte.com/docs/components/accordion) |
| Alert | [🟢](https://ui.shadcn.com/docs/components/alert) | [🟢](https://www.shadcn-svelte.com/docs/components/alert) |
| Alert Dialog | [🟢](https://ui.shadcn.com/docs/components/alert-dialog) | [🟢](https://www.shadcn-svelte.com/docs/components/alert-dialog) |
| Aspect Ratio | [🟢](https://ui.shadcn.com/docs/components/aspect-ratio) | [🟢](https://www.shadcn-svelte.com/docs/components/aspect-ratio) |
...
| Components.Json | ❌ | ❌ |
| Context Menu | [🟢](https://ui.shadcn.com/docs/components/context-menu) | [🟢](https://www.shadcn-svelte.com/docs/components/context-menu) |
| Dark Mode | ❌ | ❌ |
| Data Table | [🟢](https://ui.shadcn.com/docs/components/data-table) | [🟢](https://www.shadcn-svelte.com/docs/components/data-table) |
| Date Picker | [🟢](https://ui.shadcn.com/docs/components/date-picker) | [🟢](https://www.shadcn-svelte.com/docs/components/date-picker) |
...
| Label | [🟢](https://ui.shadcn.com/docs/components/label) | [🟢](https://www.shadcn-svelte.com/docs/components/label) |
...
| Toggle | [🟢](https://ui.shadcn.com/docs/components/toggle) | [🟢](https://www.shadcn-svelte.com/docs/components/toggle) |
| Toggle Group | [🟢](https://ui.shadcn.com/docs/components/toggle-group) | [🟢](https://www.shadcn-svelte.com/docs/components/toggle-group) |
| Tooltip | [🟢](https://ui.shadcn.com/docs/components/tooltip) | [🟢](https://www.shadcn-svelte.com/docs/components/tooltip) |
...
| --- | --- | --- | --- | --- |
| Accordion | [🟢](https://ui.shadcn.com/docs/components/accordion) | [🟢](https://www.shadcn-svelte.com/docs/components/accordion) | [🟢](https://www.bits-ui.com/docs/components/accordion) | [🟢](https://melt-ui.com/docs/builders/accordion) |
| Alert | [🟢](https://ui.shadcn.com/docs/components/alert) | [🟢](https://www.shadcn-svelte.com/docs/components/alert) | ❌ | ❌ |
| Alert Dialog | [🟢](https://ui.shadcn.com/docs/components/alert-dialog) | [🟢](https://www.shadcn-svelte.com/docs/components/alert-dialog) | [🟢](https://www.bits-ui.com/docs/components/alert-dialog) | ❌ |
| Aspect Ratio | [🟢](https://ui.shadcn.com/docs/components/aspect-ratio) | [🟢](https://www.shadcn-svelte.com/docs/components/aspect-ratio) | [🟢](https://www.bits-ui.com/docs/components/aspect-ratio) | ❌ |
| Astro | [🟢](https://ui.shadcn.com/docs/installation/astro) | ❌ | ❌ | ❌ |
...
| Date Picker | [🟢](https://ui.shadcn.com/docs/components/date-picker) | [🟢](https://www.shadcn-svelte.com/docs/components/date-picker) | [🟢](https://www.bits-ui.com/docs/components/date-picker) | [🟢](https://melt-ui.com/docs/builders/date-picker) |
...
| Installation | [🟢](https://ui.shadcn.com/docs/installation) | ❌ | ❌ | ❌ |
| Introduction | [🟢](https://ui.shadcn.com/docs) | ❌ | ❌ | ❌ |
| Label | [🟢](https://ui.shadcn.com/docs/components/label) | [🟢](https://www.shadcn-svelte.com/docs/components/label) | [🟢](https://www.bits-ui.com/docs/components/label) | [🟢](https://melt-ui.com/docs/builders/label) |
| Laravel | [🟢](https://ui.shadcn.com/docs/installation/laravel) | ❌ | ❌ | ❌ |
...
| Popover | [🟢](https://ui.shadcn.com/docs/components/popover) | [🟢](https://www.shadcn-svelte.com/docs/components/popover) | [🟢](https://www.bits-ui.com/docs/components/popover) | [🟢](https://melt-ui.com/docs/builders/popover) |
...
| Sonner | [🟢](https://ui.shadcn.com/docs/components/sonner) | [🟢](https://www.shadcn-svelte.com/docs/components/sonner) | ❌ | ❌ |
| Switch | [🟢](https://ui.shadcn.com/docs/components/switch) | [🟢](https://www.shadcn-svelte.com/docs/components/switch) | [🟢](https://www.bits-ui.com/docs/components/switch) | [🟢](https://melt-ui.com/docs/builders/switch) |
| Table | [🟢](https://ui.shadcn.com/docs/components/table) | [🟢](https://www.shadcn-svelte.com/docs/components/table) | ❌ | ❌ |
...
| Tooltip | [🟢](https://ui.shadcn.com/docs/components/tooltip) | [🟢](https://www.shadcn-svelte.com/docs/components/tooltip) | [🟢](https://www.bits-ui.com/docs/components/tooltip) | [🟢](https://melt-ui.com/docs/builders/tooltip) |
